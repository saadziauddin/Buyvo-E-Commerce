    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        const response = await Promise.race([
          api.get("/api/fetchProductsByCategory/specialOffers"),
          timeoutPromise,
        ]);
        ...
        console.error("Error fetching special offers:", error.message || error);
        setError(error.message || "Failed to load special offers. Please try again later."); // Set error message
      } finally {
    ...
    <div className="mb-10 z-10">
      ...
      <div className="relative text-center pt-10 pb-0">
        ...
        <div className="flex items-center justify-center">
          ...
          <span className="text-xl md:text-2xl lg:text-3xl font-semibold uppercase">Special Offers</span>
          <div className="flex-grow border-t-4 border-black mx-5 md:mx-10"></div>
        </div>
      </div>
