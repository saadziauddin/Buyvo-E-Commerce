...
import TopTrendingImage from "/Images/TopTrending.jpg";
...
const NayabExclusive = () => {
  return (
    ...
    <Link to="/products" className="z-10">
      <img className="w-full h-[120px] md:h-[250px] lg:h-[350px] object-center cursor-pointer" src={TopTrendingImage} alt="Nayab Exclusive" />
    </Link>
  );
};
