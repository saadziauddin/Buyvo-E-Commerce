    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        const response = await Promise.race([
          api.get("/api/fetchProductsByCategory/newArrivals"),
          timeoutPromise,
        ]);
        ...
        console.error("Error fetching new arrivals:", error.message || error);
        setError(error.message || "Failed to load new arrivals. Please try again later."); // Set error message
      } finally {
    ...
    <>
      ...
      <div className="relative text-center pt-10 pb-0">
        ...
        <div className="flex items-center justify-center">
          ...
          <span className="text-xl md:text-2xl lg:text-3xl font-semibold uppercase">New Arrivals</span>
          <div className="flex-grow border-t-4 border-black mx-5 md:mx-10"></div>
        </div>
      </div>
